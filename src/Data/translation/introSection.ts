export const introSection = {
  en: {
    ...
    info: `We took the values we learned as freelancers and
		...
		demonstrating a love of detail in everything we produce. We
		we create fashion for the modern urban athlete, aesthetically
		clean and practical.`,
  ...
  ua: {
    ...
    info: `Ми взяли цінності, яких навчилися, будучи фріранерами, і
		...
		демонструвати любов до деталей у всьому, що ми виробляємо. Ми
		створюємо моду для сучасного міського спортсмена, естетично
		чисту та практичну.`,
